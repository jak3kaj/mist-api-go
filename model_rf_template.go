...
type RfTemplate struct {
	...
	Band24 *AllOfrfTemplateBand24 `json:"band_24,omitempty"`
	Band24Usage *AllOfrfTemplateBand24Usage `json:"band_24_usage,omitempty"`
	Band5 *AllOfrfTemplateBand5 `json:"band_5,omitempty"`
	Band5On24Radio *AllOfrfTemplateBand5On24Radio `json:"band_5_on_24_radio,omitempty"`
	Band6 *AllOfrfTemplateBand6 `json:"band_6,omitempty"`
