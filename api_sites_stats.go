...
type SitesStatsApiService service
/*
SitesStatsApiService getSiteStats
Get Sites Stats
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId
@return InlineResponse200167
*/
func (a *SitesStatsApiService) GetSiteStats(ctx context.Context, siteId string) (InlineResponse200167, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/sites/{site_id}/stats"
