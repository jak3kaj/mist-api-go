...
type SiteSetting struct {
	...
	AutoPlacement *AllOfsiteSettingAutoPlacement `json:"auto_placement,omitempty"`
	AutoUpgrade *AllOfsiteSettingAutoUpgrade `json:"auto_upgrade,omitempty"`
	BlacklistUrl string `json:"blacklist_url,omitempty"`
	BleConfig *AllOfsiteSettingBleConfig `json:"ble_config,omitempty"`
	// whether to enable ap auto config revert
	ConfigAutoRevert bool `json:"config_auto_revert,omitempty"`
	ConfigPushPolicy *AllOfsiteSettingConfigPushPolicy `json:"config_push_policy,omitempty"`
	CreatedTime float64 `json:"created_time,omitempty"`
	CriticalUrlMonitoring *AllOfsiteSettingCriticalUrlMonitoring `json:"critical_url_monitoring,omitempty"`
	...
	Engagement *AllOfsiteSettingEngagement `json:"engagement,omitempty"`
	EvpnOptions *AllOfsiteSettingEvpnOptions `json:"evpn_options,omitempty"`
	...
	Gateway *AllOfsiteSettingGateway `json:"gateway,omitempty"`
	// additional CLI commands to append to the generated Junos config  **Note**: no check is done
	GatewayAdditionalConfigCmds []string `json:"gateway_additional_config_cmds,omitempty"`
	GatewayMgmt *AllOfsiteSettingGatewayMgmt `json:"gateway_mgmt,omitempty"`
	...
	Led *AllOfsiteSettingLed `json:"led,omitempty"`
	MistNac *AllOfsiteSettingMistNac `json:"mist_nac,omitempty"`
	ModifiedTime float64 `json:"modified_time,omitempty"`
	Mxedge *AllOfsiteSettingMxedge `json:"mxedge,omitempty"`
	MxedgeMgmt *MxedgeMgmt `json:"mxedge_mgmt,omitempty"`
	Mxtunnels *AllOfsiteSettingMxtunnels `json:"mxtunnels,omitempty"`
	// Property key is network name
	Networks map[string]SwitchNetwork `json:"networks,omitempty"`
	// list of NTP servers
	NtpServers []string `json:"ntp_servers,omitempty"`
	Occupancy *AllOfsiteSettingOccupancy `json:"occupancy,omitempty"`
	...
	Proxy *AllOfsiteSettingProxy `json:"proxy,omitempty"`
	RadioConfig *AllOfsiteSettingRadioConfig `json:"radio_config,omitempty"`
	RadiusConfig *AllOfsiteSettingRadiusConfig `json:"radius_config,omitempty"`
	...
	Rogue *AllOfsiteSettingRogue `json:"rogue,omitempty"`
	Rtsa *AllOfsiteSettingRtsa `json:"rtsa,omitempty"`
	SimpleAlert *AllOfsiteSettingSimpleAlert `json:"simple_alert,omitempty"`
	...
	Switch_ *AllOfsiteSettingSwitch_ `json:"switch,omitempty"`
	SwitchMatching *AllOfsiteSettingSwitchMatching `json:"switch_matching,omitempty"`
	SwitchMgmt *AllOfsiteSettingSwitchMgmt `json:"switch_mgmt,omitempty"`
	...
	Wids *AllOfsiteSettingWids `json:"wids,omitempty"`
	Wifi *AllOfsiteSettingWifi `json:"wifi,omitempty"`
	WiredVna *SiteSettingWiredVna `json:"wired_vna,omitempty"`
	ZoneOccupancyAlert *AllOfsiteSettingZoneOccupancyAlert `json:"zone_occupancy_alert,omitempty"`
}
