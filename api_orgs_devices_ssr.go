...
/*
OrgsDevicesSSRApiService getOrg128TRegistrationCommands
128T devices can be managed/adopted by Mist.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId
@return InlineResponse20051
*/
func (a *OrgsDevicesSSRApiService) GetOrg128TRegistrationCommands(ctx context.Context, orgId string) (InlineResponse20051, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/128routers/register_cmd"
