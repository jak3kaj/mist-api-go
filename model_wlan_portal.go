...
type WlanPortal struct {
	...
	Auth *AllOfwlanPortalAuth `json:"auth,omitempty"`
	...
	SmsProvider *AllOfwlanPortalSmsProvider `json:"sms_provider,omitempty"`
	...
	Sponsors *AllOfwlanPortalSponsors `json:"sponsors,omitempty"`
	...
	SsoIdpSignAlgo *AllOfwlanPortalSsoIdpSignAlgo `json:"sso_idp_sign_algo,omitempty"`
	...
	SsoNameidFormat *AllOfwlanPortalSsoNameidFormat `json:"sso_nameid_format,omitempty"`
