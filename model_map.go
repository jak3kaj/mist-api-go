...
type ModelMap struct {
	...
	LatlngBr *AllOfMapLatlngBr `json:"latlng_br,omitempty"`
	LatlngTl *AllOfMapLatlngTl `json:"latlng_tl,omitempty"`
	...
	Type_ *AllOfMapType_ `json:"type,omitempty"`
	...
	View *AllOfMapView `json:"view,omitempty"`
	WallPath *AllOfMapWallPath `json:"wall_path,omitempty"`
	Wayfinding *AllOfMapWayfinding `json:"wayfinding,omitempty"`
	WayfindingPath *AllOfMapWayfindingPath `json:"wayfinding_path,omitempty"`
