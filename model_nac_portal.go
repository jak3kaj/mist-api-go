...
type NacPortal struct {
	AccessType *AllOfnacPortalAccessType `json:"access_type,omitempty"`
	// background image
	BgImageUrl string `json:"bg_image_url,omitempty"`
	// in days
	CertExpireTime int32 `json:"cert_expire_time,omitempty"`
	EapType *AllOfnacPortalEapType `json:"eap_type,omitempty"`
	...
	GuestPortalConfig *AllOfnacPortalGuestPortalConfig `json:"guest_portal_config,omitempty"`
	...
	Type_ *AllOfnacPortalType_ `json:"type,omitempty"`
}
