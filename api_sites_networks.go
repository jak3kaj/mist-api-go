...
/*
SitesNetworksApiService listSiteNetworksDerived
Retrieves the list of Networks available for the Site
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId
 * @param optional nil or *SitesNetworksApiListSiteNetworksDerivedOpts - Optional Parameters:
     * @param "Resolve" (optional.Bool) -  whether resolve the site variables
@return []Network
*/

type SitesNetworksApiListSiteNetworksDerivedOpts struct {
    Resolve optional.Bool
}

func (a *SitesNetworksApiService) ListSiteNetworksDerived(ctx context.Context, siteId string, localVarOptionals *SitesNetworksApiListSiteNetworksDerivedOpts) ([]Network, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/sites/{site_id}/networks/derived"
