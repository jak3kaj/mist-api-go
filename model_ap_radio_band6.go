...
type ApRadioBand6 struct {
	...
	AntennaMode *AllOfapRadioBand6AntennaMode `json:"antenna_mode,omitempty"`
	Bandwidth *AllOfapRadioBand6Bandwidth `json:"bandwidth,omitempty"`
	...
	Preamble *AllOfapRadioBand6Preamble `json:"preamble,omitempty"`
