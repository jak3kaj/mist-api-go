...
/*
MSPsTicketsApiService countMspTickets
Count tickets
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param mspId
 * @param optional nil or *MSPsTicketsApiCountMspTicketsOpts - Optional Parameters:
     * @param "Distinct" (optional.Interface of MspTicketsCountDistinct) - 
@return InlineResponse20016
*/

type MSPsTicketsApiCountMspTicketsOpts struct {
    Distinct optional.Interface
}

func (a *MSPsTicketsApiService) CountMspTickets(ctx context.Context, mspId string, localVarOptionals *MSPsTicketsApiCountMspTicketsOpts) (InlineResponse20016, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/msps/{msp_id}/tickets/count"
...
/*
MSPsTicketsApiService listMspTickets
Get List of Tickets of a MSP
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param mspId
 * @param optional nil or *MSPsTicketsApiListMspTicketsOpts - Optional Parameters:
...
type MSPsTicketsApiListMspTicketsOpts struct {
    Start optional.Int32
    End optional.Int32
    Duration optional.String
}

func (a *MSPsTicketsApiService) ListMspTickets(ctx context.Context, mspId string, localVarOptionals *MSPsTicketsApiListMspTicketsOpts) ([]Ticket, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/msps/{msp_id}/tickets"
	localVarPath = strings.Replace(localVarPath, "{"+"msp_id"+"}", fmt.Sprintf("%v", mspId), -1)
