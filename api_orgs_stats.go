...
type OrgsStatsApiService service
/*
OrgsStatsApiService getOrgStats
Get Org Stats
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId
 * @param optional nil or *OrgsStatsApiGetOrgStatsOpts - Optional Parameters:
...
type OrgsStatsApiGetOrgStatsOpts struct {
...
func (a *OrgsStatsApiService) GetOrgStats(ctx context.Context, orgId string, localVarOptionals *OrgsStatsApiGetOrgStatsOpts) (InlineResponse20074, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/stats"
