...
type StatsMxedge struct {
	...
	MemoryStat *AllOfstatsMxedgeMemoryStat `json:"memory_stat,omitempty"`
	...
	OobIpConfig *AllOfstatsMxedgeOobIpConfig `json:"oob_ip_config,omitempty"`
