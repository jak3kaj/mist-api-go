...
type SwitchDhcpdConfigProperty struct {
	...
	Type_ *AllOfswitchDhcpdConfigPropertyType_ `json:"type,omitempty"`
	Type6 *AllOfswitchDhcpdConfigPropertyType6 `json:"type6,omitempty"`
	// if `type`==`server` or `type6`==`server`. Property key is <enterprise number>:<sub option code>, with   * enterprise number: 1-65535 (https://www.iana.org/assignments/enterprise-numbers/enterprise-numbers)   * sub option code: 1-255, sub-option code'
