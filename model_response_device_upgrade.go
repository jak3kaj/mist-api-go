...
type ResponseDeviceUpgrade struct {
	Counts *AllOfresponseDeviceUpgradeCounts `json:"counts,omitempty"`
	...
	Status *AllOfresponseDeviceUpgradeStatus `json:"status,omitempty"`
	Strategy *AllOfresponseDeviceUpgradeStrategy `json:"strategy,omitempty"`
