...
type NetworkTemplate struct {
	...
	MistNac *AllOfnetworkTemplateMistNac `json:"mist_nac,omitempty"`
	...
	RadiusConfig *AllOfnetworkTemplateRadiusConfig `json:"radius_config,omitempty"`
	...
	SwitchMatching *AllOfnetworkTemplateSwitchMatching `json:"switch_matching,omitempty"`
	SwitchMgmt *AllOfnetworkTemplateSwitchMgmt `json:"switch_mgmt,omitempty"`
