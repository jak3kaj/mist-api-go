...
/*
OrgsLogsApiService countOrgAuditLogs
Count by Distinct Attributes of Audit Logs
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId
 * @param optional nil or *OrgsLogsApiCountOrgAuditLogsOpts - Optional Parameters:
     * @param "Distinct" (optional.Interface of OrgLogsCountDistinct) - 
...
type OrgsLogsApiCountOrgAuditLogsOpts struct {
...
func (a *OrgsLogsApiService) CountOrgAuditLogs(ctx context.Context, orgId string, localVarOptionals *OrgsLogsApiCountOrgAuditLogsOpts) (InlineResponse20016, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/logs/count"
...
/*
OrgsLogsApiService listOrgAuditLogs
Get List of change logs for the current Org
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId
 * @param optional nil or *OrgsLogsApiListOrgAuditLogsOpts - Optional Parameters:
     ...
     * @param "Sort" (optional.Interface of Sort1) -  sort order
     * @param "Start" (optional.Int32) -  start datetime, can be epoch or relative time like -1d, -1w; -1d if not specified
     * @param "End" (optional.Int32) -  end datetime, can be epoch or relative time like -1d, -2h; now if not specified
     * @param "Duration" (optional.String) -  duration like 7d, 2w
     * @param "Limit" (optional.Int32) - 
...
type OrgsLogsApiListOrgAuditLogsOpts struct {
    SiteId optional.String
    AdminName optional.String
    Message optional.String
...
func (a *OrgsLogsApiService) ListOrgAuditLogs(ctx context.Context, orgId string, localVarOptionals *OrgsLogsApiListOrgAuditLogsOpts) (InlineResponse20015, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/logs"
	localVarPath = strings.Replace(localVarPath, "{"+"org_id"+"}", fmt.Sprintf("%v", orgId), -1)
