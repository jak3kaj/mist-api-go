...
/*
OrgsMarvisApiService troubleshootOrg
 ...
 * @param orgId
 * @param optional nil or *OrgsMarvisApiTroubleshootOrgOpts - Optional Parameters:
     * @param "Mac" (optional.String) -  **required** when troubleshooting device or a client
     * @param "SiteId" (optional.Interface of string) -  **required** when troubleshooting site
     ...
     * @param "Type_" (optional.Interface of Type1) -  when troubleshooting site, type of network to troubleshoot
@return InlineResponse20065
*/

type OrgsMarvisApiTroubleshootOrgOpts struct {
    Mac optional.String
...
func (a *OrgsMarvisApiService) TroubleshootOrg(ctx context.Context, orgId string, localVarOptionals *OrgsMarvisApiTroubleshootOrgOpts) (InlineResponse20065, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/troubleshoot"
