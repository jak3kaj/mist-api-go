...
type Sso struct {
	...
	IdpSignAlgo *AllOfssoIdpSignAlgo `json:"idp_sign_algo,omitempty"`
	// Required if `idp_type`==`saml`, IDP Single-Sign-On URL
	IdpSsoUrl string `json:"idp_sso_url,omitempty"`
	IdpType *AllOfssoIdpType `json:"idp_type,omitempty"`
	...
	LdapType *AllOfssoLdapType `json:"ldap_type,omitempty"`
	...
	MxedgeProxy *AllOfssoMxedgeProxy `json:"mxedge_proxy,omitempty"`
	// name
	Name string `json:"name"`
	NameidFormat *AllOfssoNameidFormat `json:"nameid_format,omitempty"`
	...
	OauthType *AllOfssoOauthType `json:"oauth_type,omitempty"`
