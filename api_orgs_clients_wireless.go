...
/*
OrgsClientsWirelessApiService countOrgWirelessClients
Count Org Wireless Clients
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId
 * @param optional nil or *OrgsClientsWirelessApiCountOrgWirelessClientsOpts - Optional Parameters:
     * @param "Distinct" (optional.Interface of OrgClientsCountDistinct) - 
     ...
     * @param "Vlan" (optional.String) -  vlan
...
type OrgsClientsWirelessApiCountOrgWirelessClientsOpts struct {
...
func (a *OrgsClientsWirelessApiService) CountOrgWirelessClients(ctx context.Context, orgId string, localVarOptionals *OrgsClientsWirelessApiCountOrgWirelessClientsOpts) (InlineResponse20016, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/clients/count"
...
/*
OrgsClientsWirelessApiService countOrgWirelessClientsSessions
Count Org Wireless Clients Sessions
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId
 * @param optional nil or *OrgsClientsWirelessApiCountOrgWirelessClientsSessionsOpts - Optional Parameters:
     * @param "Distinct" (optional.Interface of OrgClientSessionsCountDistinct) - 
     * @param "Ap" (optional.String) -  AP MAC
     * @param "Band" (optional.Interface of Band1) -  802.11 Band
...
type OrgsClientsWirelessApiCountOrgWirelessClientsSessionsOpts struct {
    Distinct optional.Interface
    Ap optional.String
...
func (a *OrgsClientsWirelessApiService) CountOrgWirelessClientsSessions(ctx context.Context, orgId string, localVarOptionals *OrgsClientsWirelessApiCountOrgWirelessClientsSessionsOpts) (InlineResponse20016, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/clients/sessions/count"
	localVarPath = strings.Replace(localVarPath, "{"+"org_id"+"}", fmt.Sprintf("%v", orgId), -1)
...
/*
OrgsClientsWirelessApiService searchOrgWirelessClientEvents
Get Org Clients Events
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId
 * @param optional nil or *OrgsClientsWirelessApiSearchOrgWirelessClientEventsOpts - Optional Parameters:
     ...
     * @param "Ap" (optional.String) -  AP MAC
     * @param "Proto" (optional.Interface of Proto) -  a / b / g / n / ac / ax
     * @param "Band" (optional.Interface of Band) -  802.11 Band
     * @param "WlanId" (optional.String) -  wlan_id
...
type OrgsClientsWirelessApiSearchOrgWirelessClientEventsOpts struct {
...
func (a *OrgsClientsWirelessApiService) SearchOrgWirelessClientEvents(ctx context.Context, orgId string, localVarOptionals *OrgsClientsWirelessApiSearchOrgWirelessClientEventsOpts) (InlineResponse20042, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/clients/events/search"
	localVarPath = strings.Replace(localVarPath, "{"+"org_id"+"}", fmt.Sprintf("%v", orgId), -1)
...
/*
OrgsClientsWirelessApiService searchOrgWirelessClientSessions
Search Org Wireless Clients Sessions
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId
 * @param optional nil or *OrgsClientsWirelessApiSearchOrgWirelessClientSessionsOpts - Optional Parameters:
     * @param "Ap" (optional.String) -  AP MAC
     * @param "Band" (optional.Interface of Band2) -  802.11 Band
     * @param "ClientFamily" (optional.String) -  E.g. “Mac”, “iPhone”, “Apple watch”
     * @param "ClientManufacture" (optional.String) -  E.g. “Apple”
     * @param "ClientModel" (optional.String) -  E.g. “8+”, “XS”
...
type OrgsClientsWirelessApiSearchOrgWirelessClientSessionsOpts struct {
    Ap optional.String
    Band optional.Interface
    ClientFamily optional.String
    ClientManufacture optional.String
...
func (a *OrgsClientsWirelessApiService) SearchOrgWirelessClientSessions(ctx context.Context, orgId string, localVarOptionals *OrgsClientsWirelessApiSearchOrgWirelessClientSessionsOpts) (InlineResponse20044, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/clients/sessions/search"
	localVarPath = strings.Replace(localVarPath, "{"+"org_id"+"}", fmt.Sprintf("%v", orgId), -1)
...
/*
OrgsClientsWirelessApiService searchOrgWirelessClients
Search Org Wireless Clients
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId
 * @param optional nil or *OrgsClientsWirelessApiSearchOrgWirelessClientsOpts - Optional Parameters:
...
type OrgsClientsWirelessApiSearchOrgWirelessClientsOpts struct {
...
func (a *OrgsClientsWirelessApiService) SearchOrgWirelessClients(ctx context.Context, orgId string, localVarOptionals *OrgsClientsWirelessApiSearchOrgWirelessClientsOpts) (InlineResponse20043, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/clients/search"
	localVarPath = strings.Replace(localVarPath, "{"+"org_id"+"}", fmt.Sprintf("%v", orgId), -1)
