...
type RftemplateRadioBand6 struct {
	...
	AntennaMode *AllOfrftemplateRadioBand6AntennaMode `json:"antenna_mode,omitempty"`
	Bandwidth *AllOfrftemplateRadioBand6Bandwidth `json:"bandwidth,omitempty"`
	...
	Preamble *AllOfrftemplateRadioBand6Preamble `json:"preamble,omitempty"`
