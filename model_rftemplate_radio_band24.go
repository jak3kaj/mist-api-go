...
type RftemplateRadioBand24 struct {
	...
	AntennaMode *AllOfrftemplateRadioBand24AntennaMode `json:"antenna_mode,omitempty"`
	Bandwidth *AllOfrftemplateRadioBand24Bandwidth `json:"bandwidth,omitempty"`
	...
	Preamble *AllOfrftemplateRadioBand24Preamble `json:"preamble,omitempty"`
}
