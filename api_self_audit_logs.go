...
/*
SelfAuditLogsApiService listSelfAuditLogs
 ...
 * @param optional nil or *SelfAuditLogsApiListSelfAuditLogsOpts - Optional Parameters:
...
type SelfAuditLogsApiListSelfAuditLogsOpts struct {
...
func (a *SelfAuditLogsApiService) ListSelfAuditLogs(ctx context.Context, localVarOptionals *SelfAuditLogsApiListSelfAuditLogsOpts) (InlineResponse200185, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/self/logs"
