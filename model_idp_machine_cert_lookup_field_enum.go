 ...
 */
package swagger
// IdpMachineCertLookupFieldEnum : allow customer to choose the EAP-TLS client certificate's field to use for IDP Machine Groups lookup. enum: `automatic`, `cn`, `email`, `upn`
