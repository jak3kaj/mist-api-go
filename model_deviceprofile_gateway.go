...
type DeviceprofileGateway struct {
	...
	GatewayMatching *AllOfdeviceprofileGatewayGatewayMatching `json:"gateway_matching,omitempty"`
	...
	OobIpConfig *AllOfdeviceprofileGatewayOobIpConfig `json:"oob_ip_config,omitempty"`
