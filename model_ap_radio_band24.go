...
type ApRadioBand24 struct {
	...
	AntennaMode *AllOfapRadioBand24AntennaMode `json:"antenna_mode,omitempty"`
	Bandwidth *AllOfapRadioBand24Bandwidth `json:"bandwidth,omitempty"`
	...
	Preamble *AllOfapRadioBand24Preamble `json:"preamble,omitempty"`
}
