...
type MxclusterRadsec struct {
	...
	NasIpSource *AllOfmxclusterRadsecNasIpSource `json:"nas_ip_source,omitempty"`
	...
	ServerSelection *AllOfmxclusterRadsecServerSelection `json:"server_selection,omitempty"`
	SrcIpSource *AllOfmxclusterRadsecSrcIpSource `json:"src_ip_source,omitempty"`
}
