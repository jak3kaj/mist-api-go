...
type RftemplateRadioBand5 struct {
	...
	AntennaMode *AllOfrftemplateRadioBand5AntennaMode `json:"antenna_mode,omitempty"`
	Bandwidth *AllOfrftemplateRadioBand5Bandwidth `json:"bandwidth,omitempty"`
	...
	Preamble *AllOfrftemplateRadioBand5Preamble `json:"preamble,omitempty"`
}
