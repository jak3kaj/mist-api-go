...
type Mxedge struct {
	...
	OobIpConfig *AllOfmxedgeOobIpConfig `json:"oob_ip_config,omitempty"`
	OrgId string `json:"org_id,omitempty"`
	Proxy *AllOfmxedgeProxy `json:"proxy,omitempty"`
	// list of services to run, tunterm only for now
	Services []string `json:"services,omitempty"`
	SiteId string `json:"site_id,omitempty"`
	TuntermDhcpdConfig *AllOfmxedgeTuntermDhcpdConfig `json:"tunterm_dhcpd_config,omitempty"`
	...
	TuntermIpConfig *AllOfmxedgeTuntermIpConfig `json:"tunterm_ip_config,omitempty"`
	...
	TuntermPortConfig *AllOfmxedgeTuntermPortConfig `json:"tunterm_port_config,omitempty"`
	TuntermRegistered bool `json:"tunterm_registered,omitempty"`
	TuntermSwitchConfig *AllOfmxedgeTuntermSwitchConfig `json:"tunterm_switch_config,omitempty"`
	Versions *AllOfmxedgeVersions `json:"versions,omitempty"`
}
