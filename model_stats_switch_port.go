...
type StatsSwitchPort struct {
	...
	AuthState *AllOfstatsSwitchPortAuthState `json:"auth_state,omitempty"`
	...
	PoeMode *AllOfstatsSwitchPortPoeMode `json:"poe_mode,omitempty"`
	// is the device attached to POE
	PoeOn bool `json:"poe_on,omitempty"`
	PortId string `json:"port_id"`
	// interface mac address
	PortMac string `json:"port_mac"`
	PortUsage *AllOfstatsSwitchPortPortUsage `json:"port_usage,omitempty"`
	...
	StpRole *AllOfstatsSwitchPortStpRole `json:"stp_role,omitempty"`
	StpState *AllOfstatsSwitchPortStpState `json:"stp_state,omitempty"`
	...
	Type_ *AllOfstatsSwitchPortType_ `json:"type,omitempty"`
