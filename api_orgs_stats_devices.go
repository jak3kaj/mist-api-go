...
type OrgsStatsDevicesApiService service
/*
OrgsStatsDevicesApiService listOrgDevicesStats
 ...
 * @param orgId
 * @param optional nil or *OrgsStatsDevicesApiListOrgDevicesStatsOpts - Optional Parameters:
     * @param "Type_" (optional.Interface of DeviceTypeWithAll) - 
     * @param "Status" (optional.Interface of DeviceStatus) - 
     * @param "SiteId" (optional.String) - 
     * @param "Mac" (optional.String) - 
     * @param "EvpntopoId" (optional.String) -  EVPN Topology ID
     * @param "EvpnUnused" (optional.String) -  if &#x60;evpn_unused&#x60;&#x3D;&#x3D;&#x60;true&#x60;, find EVPN eligible switches which don’t belong to any EVPN Topology yet
...
type OrgsStatsDevicesApiListOrgDevicesStatsOpts struct {
    Type_ optional.Interface
    Status optional.Interface
    SiteId optional.String
    Mac optional.String
    EvpntopoId optional.String
    EvpnUnused optional.String
...
func (a *OrgsStatsDevicesApiService) ListOrgDevicesStats(ctx context.Context, orgId string, localVarOptionals *OrgsStatsDevicesApiListOrgDevicesStatsOpts) ([]StatsDevice, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/stats/devices"
	...
	if localVarOptionals != nil && localVarOptionals.EvpntopoId.IsSet() {
		localVarQueryParams.Add("evpntopo_id", parameterToString(localVarOptionals.EvpntopoId.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.EvpnUnused.IsSet() {
		localVarQueryParams.Add("evpn_unused", parameterToString(localVarOptionals.EvpnUnused.Value(), ""))
	}
