...
type OrgsStatsVPNPeersApiService service
/*
OrgsStatsVPNPeersApiService countOrgPeerPathStats
Count Org Peer Path Statgs
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId
 * @param optional nil or *OrgsStatsVPNPeersApiCountOrgPeerPathStatsOpts - Optional Parameters:
...
type OrgsStatsVPNPeersApiCountOrgPeerPathStatsOpts struct {
...
func (a *OrgsStatsVPNPeersApiService) CountOrgPeerPathStats(ctx context.Context, orgId string, localVarOptionals *OrgsStatsVPNPeersApiCountOrgPeerPathStatsOpts) (InlineResponse20016, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/stats/vpn_peers/count"
...
/*
OrgsStatsVPNPeersApiService searchOrgPeerPathStats
Search Org Peer Path Stats
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId
 * @param optional nil or *OrgsStatsVPNPeersApiSearchOrgPeerPathStatsOpts - Optional Parameters:
     * @param "Start" (optional.Int32) -  start datetime, can be epoch or relative time like -1d, -1w; -1d if not specified
     * @param "End" (optional.Int32) -  end datetime, can be epoch or relative time like -1d, -2h; now if not specified
     * @param "Duration" (optional.String) -  duration like 7d, 2w
     * @param "Limit" (optional.Int32) - 
...
type OrgsStatsVPNPeersApiSearchOrgPeerPathStatsOpts struct {
    Start optional.Int32
    End optional.Int32
    Duration optional.String
    Limit optional.Int32
...
func (a *OrgsStatsVPNPeersApiService) SearchOrgPeerPathStats(ctx context.Context, orgId string, localVarOptionals *OrgsStatsVPNPeersApiSearchOrgPeerPathStatsOpts) (InlineResponse20080, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/orgs/{org_id}/stats/vpn_peers/search"
	localVarPath = strings.Replace(localVarPath, "{"+"org_id"+"}", fmt.Sprintf("%v", orgId), -1)
