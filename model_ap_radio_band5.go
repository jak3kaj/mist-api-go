...
type ApRadioBand5 struct {
	...
	AntennaMode *AllOfapRadioBand5AntennaMode `json:"antenna_mode,omitempty"`
	Bandwidth *AllOfapRadioBand5Bandwidth `json:"bandwidth,omitempty"`
	...
	Preamble *AllOfapRadioBand5Preamble `json:"preamble,omitempty"`
}
