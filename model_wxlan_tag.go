...
type WxlanTag struct {
	...
	Match *AllOfwxlanTagMatch `json:"match,omitempty"`
	ModifiedTime float64 `json:"modified_time,omitempty"`
	// The name
	Name string `json:"name"`
	Op *AllOfwxlanTagOp `json:"op,omitempty"`
	...
	Type_ *AllOfwxlanTagType_ `json:"type"`
	...
	VlanId *AllOfwxlanTagVlanId `json:"vlan_id,omitempty"`
}
