...
/*
SitesLicensesApiService getSiteLicenseUsage
...
*/
func (a *SitesLicensesApiService) GetSiteLicenseUsage(ctx context.Context, siteId string) (InlineResponse200128, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/sites/{site_id}/licenses/usages"
