...
/*
SitesDeviceProfilesApiService listSiteDeviceProfilesDerived
Retrieves the list of Device Profiles available for the Site
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId
 * @param optional nil or *SitesDeviceProfilesApiListSiteDeviceProfilesDerivedOpts - Optional Parameters:
     * @param "Resolve" (optional.Bool) -  whether resolve the site variables
@return []Deviceprofile
*/

type SitesDeviceProfilesApiListSiteDeviceProfilesDerivedOpts struct {
    Resolve optional.Bool
}

func (a *SitesDeviceProfilesApiService) ListSiteDeviceProfilesDerived(ctx context.Context, siteId string, localVarOptionals *SitesDeviceProfilesApiListSiteDeviceProfilesDerivedOpts) ([]Deviceprofile, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/sites/{site_id}/deviceprofiles/derived"
