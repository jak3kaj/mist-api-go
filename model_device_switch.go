...
// Switch Configuration. You can configure `port_usages` and `networks` settings at the device level, but most of the time it's better use the Site Setting to achieve better consistency and be able to re-use the same settings across switches entries defined here will \"replace\" those defined in Site Setting/Network Template
type DeviceSwitch struct {
	...
	EvpnConfig *AllOfdeviceSwitchEvpnConfig `json:"evpn_config,omitempty"`
	...
	IpConfig *AllOfdeviceSwitchIpConfig `json:"ip_config,omitempty"`
	// device MAC address
	...
	MistNac *AllOfdeviceSwitchMistNac `json:"mist_nac,omitempty"`
	// device Model
	...
	OobIpConfig *AllOfdeviceSwitchOobIpConfig `json:"oob_ip_config,omitempty"`
	...
	RadiusConfig *AllOfdeviceSwitchRadiusConfig `json:"radius_config,omitempty"`
	...
	SwitchMgmt *AllOfdeviceSwitchSwitchMgmt `json:"switch_mgmt,omitempty"`
	...
	VirtualChassis *AllOfdeviceSwitchVirtualChassis `json:"virtual_chassis,omitempty"`
	VrfConfig *VrfConfig `json:"vrf_config,omitempty"`
	// Property key is the network name
	VrfInstances map[string]SwitchVrfInstance `json:"vrf_instances,omitempty"`
	VrrpConfig *AllOfdeviceSwitchVrrpConfig `json:"vrrp_config,omitempty"`
	// x in pixel
