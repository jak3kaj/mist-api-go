...
/*
SitesJSEApiService getSiteJseInfo
Retrieves the list of JSE orgs associated with the account
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId
@return InlineResponse20063
*/
func (a *SitesJSEApiService) GetSiteJseInfo(ctx context.Context, siteId string) (InlineResponse20063, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/sites/{site_id}/setting/jse/info"
