...
/*
SitesClientsWiredApiService countSiteWiredClients
Count by Distinct Attributes of Clients
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId
 * @param optional nil or *SitesClientsWiredApiCountSiteWiredClientsOpts - Optional Parameters:
     * @param "Distinct" (optional.Interface of SiteWiredClientsCountDistinct) - 
...
type SitesClientsWiredApiCountSiteWiredClientsOpts struct {
...
func (a *SitesClientsWiredApiService) CountSiteWiredClients(ctx context.Context, siteId string, localVarOptionals *SitesClientsWiredApiCountSiteWiredClientsOpts) (InlineResponse20016, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/sites/{site_id}/wired_clients/count"
...
/*
SitesClientsWiredApiService searchSiteWiredClients
Search Wired Clients
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId
 * @param optional nil or *SitesClientsWiredApiSearchSiteWiredClientsOpts - Optional Parameters:
     * @param "DeviceMac" (optional.String) -  device mac
     * @param "Mac" (optional.String) -  client mac
     * @param "Ip" (optional.String) -  client ip
     * @param "PortId" (optional.String) -  port id
     * @param "Vlan" (optional.String) -  vlan
     * @param "Manufacture" (optional.String) -  manufacture
...
type SitesClientsWiredApiSearchSiteWiredClientsOpts struct {
    DeviceMac optional.String
    Mac optional.String
    Ip optional.String
    PortId optional.String
...
func (a *SitesClientsWiredApiService) SearchSiteWiredClients(ctx context.Context, siteId string, localVarOptionals *SitesClientsWiredApiSearchSiteWiredClientsOpts) (InlineResponse20041, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/sites/{site_id}/wired_clients/search"
	localVarPath = strings.Replace(localVarPath, "{"+"site_id"+"}", fmt.Sprintf("%v", siteId), -1)
