...
type SitesStatsBeaconsApiService service
/*
SitesStatsBeaconsApiService listSiteBeaconsStats
Get List of Site Beacons Stats
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId
 * @param optional nil or *SitesStatsBeaconsApiListSiteBeaconsStatsOpts - Optional Parameters:
...
type SitesStatsBeaconsApiListSiteBeaconsStatsOpts struct {
...
func (a *SitesStatsBeaconsApiService) ListSiteBeaconsStats(ctx context.Context, siteId string, localVarOptionals *SitesStatsBeaconsApiListSiteBeaconsStatsOpts) ([]StatsBeacon, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []StatsBeacon
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/sites/{site_id}/stats/beacons"
