...
// WLAN  **Note**: portal_template will be forked out of wlan objects soon. To fetch portal_template, please query portal_template_url. To update portal_template, use Wlan Portal Template.
type Wlan struct {
	...
	Airwatch *AllOfwlanAirwatch `json:"airwatch,omitempty"`
	...
	AppLimit *AllOfwlanAppLimit `json:"app_limit,omitempty"`
	AppQos *AllOfwlanAppQos `json:"app_qos,omitempty"`
	ApplyTo *AllOfwlanApplyTo `json:"apply_to,omitempty"`
	// whether to enable smart arp filter
	ArpFilter bool `json:"arp_filter,omitempty"`
	Auth *AllOfwlanAuth `json:"auth,omitempty"`
	AuthServerSelection *AllOfwlanAuthServerSelection `json:"auth_server_selection,omitempty"`
	...
	Bonjour *AllOfwlanBonjour `json:"bonjour,omitempty"`
	CiscoCwa *AllOfwlanCiscoCwa `json:"cisco_cwa,omitempty"`
	// kbps
	...
	DnsServerRewrite *AllOfwlanDnsServerRewrite `json:"dns_server_rewrite,omitempty"`
	Dtim int32 `json:"dtim,omitempty"`
	DynamicPsk *AllOfwlanDynamicPsk `json:"dynamic_psk,omitempty"`
	DynamicVlan *AllOfwlanDynamicVlan `json:"dynamic_vlan,omitempty"`
	...
	Hotspot20 *AllOfwlanHotspot20 `json:"hotspot20,omitempty"`
	Id string `json:"id,omitempty"`
	InjectDhcpOption82 *WlanInjectDhcpOption82 `json:"inject_dhcp_option_82,omitempty"`
	Interface_ *AllOfwlanInterface_ `json:"interface,omitempty"`
	...
	Portal *AllOfwlanPortal `json:"portal,omitempty"`
	...
	Radsec *AllOfwlanRadsec `json:"radsec,omitempty"`
	Rateset map[string]WlanDatarates `json:"rateset,omitempty"`
	RoamMode *AllOfwlanRoamMode `json:"roam_mode,omitempty"`
	Schedule *AllOfwlanSchedule `json:"schedule,omitempty"`
	...
	VlanId *AllOfwlanVlanId `json:"vlan_id,omitempty"`
