...
/*
SitesVPNsApiService listSiteVpnsDerived
 ...
 * @param siteId
 * @param optional nil or *SitesVPNsApiListSiteVpnsDerivedOpts - Optional Parameters:
     * @param "Resolve" (optional.Bool) -  whether resolve the site variables
@return []Vpn
*/

type SitesVPNsApiListSiteVpnsDerivedOpts struct {
    Resolve optional.Bool
}

func (a *SitesVPNsApiService) ListSiteVpnsDerived(ctx context.Context, siteId string, localVarOptionals *SitesVPNsApiListSiteVpnsDerivedOpts) ([]Vpn, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/sites/{site_id}/vpns/derived"
