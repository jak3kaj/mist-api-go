...
type Service struct {
	...
	Dscp *AllOfserviceDscp `json:"dscp,omitempty"`
	FailoverPolicy *AllOfserviceFailoverPolicy `json:"failover_policy,omitempty"`
	// if `type`==`custom`, web filtering
	Hostnames []string `json:"hostnames,omitempty"`
	Id string `json:"id,omitempty"`
	MaxJitter *AllOfserviceMaxJitter `json:"max_jitter,omitempty"`
	MaxLatency *AllOfserviceMaxLatency `json:"max_latency,omitempty"`
	MaxLoss *AllOfserviceMaxLoss `json:"max_loss,omitempty"`
	...
	TrafficClass *AllOfserviceTrafficClass `json:"traffic_class,omitempty"`
	// values from `/api/v1/consts/traffic_types`
	TrafficType string `json:"traffic_type,omitempty"`
	Type_ *AllOfserviceType_ `json:"type,omitempty"`
